  ...
  <div class="w-full p-5 flex h-full flex-col items-center justify-center">
    ...
    <form @submit.prevent="login" class="mt-8 mb-6 md:mb-20 space-y-6 w-full sm:w-10/12">
      ...
      <div class="flex flex-col md:flex-row items-center justify-between">
        <label class="flex">
          <input type="checkbox" class="h-5 w-5 text-amber-600 border border-soft-orange rounded focus-visible:outline-2 focus-visible:outline-offset-2 focus:outline-none focus:ring-0 focus-visible:outline-soft-orange disabled:border-gray-300 disabled:bg-gray-100 disabled:checked:bg-gray-100" />
          <span class="ml-2 text-sm font-extralight text-gray-700 whitespace-nowrap">Lembrar-me</span>
        </label>
        <a href="#" class="text-soft-orange font-extralight text-sm hover:underline sm:ml-4 mt-2 sm:mt-0 whitespace-nowrap">Esqueceu-se da palavra-passe?</a>
      </div>
      <button 
        type="submit" 

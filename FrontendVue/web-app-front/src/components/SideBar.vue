<template>
    <div class="sidebar h-full p-2 w-[300px] overflow-y-auto text-center bg-background-orange flex flex-col justify-between">
        <div>
            <div class="text-xl">
                ...
                <div class="p-2.5 mt-20 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-soft-orange text-gray-900">
